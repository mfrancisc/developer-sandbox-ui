      ...
      <CardBody className="pf-u-w-66-on-md">
        <TextContent>
          ...
          <Text className="pf-u-color-light-200">
            ...
            try it out. Not only can you easily deploy code from your Git repo,
            you can leverage our samples, run a database, connect to Red Hat
            Managed Application Services, and edit code directly with
