...
export const getDeployments = async (axiosInstance: AxiosInstance, namespace: string, labels?: string) => {
...
export const getPersistentVolumeClaims = async (axiosInstance: AxiosInstance, namespace: string, labels?: string) => {
...
export const getStatefulSets = async (axiosInstance: AxiosInstance, namespace: string, labels?: string) => {
